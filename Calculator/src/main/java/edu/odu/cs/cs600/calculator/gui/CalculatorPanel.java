...
public class CalculatorPanel extends JPanel {
	...
	private void generateButtons(GridBagLayout gbLayout) {
        ...
        jbCeiling = bf.createButton(ButtonFactory.UNARY, "ceiling.png", "Ceiling");
        this.add(jbCeiling);
        
        gbConstraints.gridx = 1; gbConstraints.gridy = 1;
        jbFloor = bf.createButton(ButtonFactory.UNARY, "floor.png", "Floor");
        this.add(jbFloor);
        
        gbConstraints.gridx = 2; gbConstraints.gridy = 1;
        jbReciprocal = bf.createButton(ButtonFactory.UNARY, "reciprocal.png", "<html>1/x</html>");
        this.add(jbReciprocal);
        
        gbConstraints.gridx = 3; gbConstraints.gridy = 1;
        gbConstraints.gridwidth = 2;
		jbOn = bf.createButton(ButtonFactory.ON, "on.png", "On");
		this.add(jbOn);
		...
		jbSquareRoot = bf.createButton(ButtonFactory.UNARY, "square_root.png", "<html>&radic;</html>");
		this.add(jbSquareRoot);
		
		gbConstraints.gridx = 3; gbConstraints.gridy = 2;
		gbConstraints.gridwidth = 2;
		jbOff = bf.createButton(ButtonFactory.OFF, "off.png", "Off");
		this.add(jbOff);
		
		gbConstraints.gridwidth = 1;  // reset
		
        gbConstraints.gridx = 0; gbConstraints.gridy = 3;
		jb7 = bf.createButton(ButtonFactory.MORPHEME, "7.png", "7");
		this.add(jb7);
		
		gbConstraints.gridx = 1; gbConstraints.gridy = 3;
		jb8 = bf.createButton(ButtonFactory.MORPHEME, "8.png", "8");
		this.add(jb8);
		
		gbConstraints.gridx = 2; gbConstraints.gridy = 3;
		jb9 = bf.createButton(ButtonFactory.MORPHEME, "9.png", "9");
		this.add(jb9);
		...
		jbClearEntry = bf.createButton(ButtonFactory.CLEAR_ENTRY, "clear_entry.png", "CE");
		this.add(jbClearEntry);
		
		gbConstraints.gridx = 0; gbConstraints.gridy = 4;
		jb4 = bf.createButton(ButtonFactory.MORPHEME, "4.png", "4");
		this.add(jb4);
		
		gbConstraints.gridx = 1; gbConstraints.gridy = 4;
		jb5 = bf.createButton(ButtonFactory.MORPHEME, "5.png", "5");
		this.add(jb5);
		
		gbConstraints.gridx = 2; gbConstraints.gridy = 4;
		jb6 = bf.createButton(ButtonFactory.MORPHEME, "6.png", "6");
		this.add(jb6);
		...
		jbClearAll = bf.createButton(ButtonFactory.CLEAR_ALL, "clear_all.png", "C");
		this.add(jbClearAll);
		
		gbConstraints.gridx = 0; gbConstraints.gridy = 5;
		jb1 = bf.createButton(ButtonFactory.MORPHEME, "1.png", "1");
		this.add(jb1);
		
		gbConstraints.gridx = 1; gbConstraints.gridy = 5;
		jb2 = bf.createButton(ButtonFactory.MORPHEME, "2.png", "2");
		this.add(jb2);
		
		gbConstraints.gridx = 2; gbConstraints.gridy = 5;
		jb3 = bf.createButton(ButtonFactory.MORPHEME, "3.png", "3");
		this.add(jb3);
		...
		jbEquals = bf.createButton(ButtonFactory.UNARY, "equal.png", "=");
		this.add(jbEquals);
		
		gbConstraints.gridheight = 1;  // reset
		
		gbConstraints.gridx = 0; gbConstraints.gridy = 6;
		jb0 = bf.createButton(ButtonFactory.MORPHEME, "0.png", "0");
		this.add(jb0);
		...
		jbNegate = bf.createButton(ButtonFactory.UNARY, "negate.png", "<html>&plusmn;</html>");
		this.add(jbNegate);
